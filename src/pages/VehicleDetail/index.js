              ...
              <div className="wrapper-detail">
                ...
                <div className="inside-wrapper-detail">
                  <div className="detail">
                    ...
                    <div className="grid-item-detail">
                      <img src={fixieGray} alt="fixie-gray" className="item" />
                    </div>
                    <div className="grid-item-detail">
                      <img src={fixieGray} alt="fixie-gray" className="item" />
                    </div>
      ...
      <div className="container">
        <div className="btn-group">
            <div className="button1">
                <button className="chat" type="button">Chat Admin</button>
            </div>
            <div className="button2">
              <Link to='/reservation'>
                <button className="reservation" type="button">Reservation</button>
                </Link>
            </div>
